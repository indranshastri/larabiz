...
<div class="row">
    <div class="col-md-8 col-md-offset-2">
        <div class="panel panel-default">
            <div class="panel-heading">Edit Listings <a href="/dashboard" class="btn btn-default btn-xs pull-right">Back</a></div>
            <div class="panel-body">
                ...
                {{ Form::bsText('bio',$listing->bio,["placeholder"=>"About the Business"]) }}
